...
class TalentSearchAndOutplacement extends Component {
    render() {
        return (
            <Fragment>
                        ...
                        <Container>
                            <Row>
                                <Col lg="12" md="12" sm="12">
                                    <p className="pageSection__title pt-5">TALENT SEARCH & OUTPLACEMENT</p>
...
export default TalentSearchAndOutplacement;