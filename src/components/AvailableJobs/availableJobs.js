...
class avaiableJobs extends Component {
    render() {
        return (
            <Fragment>
                                ...
                                <Col lg="4" md="6" sm="12">
                                    <div className="avaiablejobs__jobCard">
                                        ...
                                        <div className="avaiablejobs__jobDes">
                                            <p className="availableJobs__jobTitle">Job Title</p>
                                            <p className="availableJobs__jobCategory">Job Category</p>
